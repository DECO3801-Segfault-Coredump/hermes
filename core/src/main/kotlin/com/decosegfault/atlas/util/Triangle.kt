...
data class Triangle(
    ...
    fun extrudeUpToPrismMesh(mpb: MeshPartBuilder, height: Float) {
        ...
        val i2 = mpb.vertex(i2V, null, null, Vector2(1f, 0f))
        val i3 = mpb.vertex(i3V, null, null, Vector2(0.745f, 0f))
        val n1 = mpb.vertex(n1V, null, null, null)
        val n2 = mpb.vertex(n2V, null, null, Vector2(0.745f, 0.263f))
        val n3 = mpb.vertex(n3V, null, null, Vector2(0f, 1f))
